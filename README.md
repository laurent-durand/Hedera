...
> CLI tool visualizing process trees as growing plants.

## Overview
This project is part of a "vibe-coding" marathon to build a diverse and high-performance portfolio. 
**Hedera** focuses on efficiency and leverages niche technologies to solve system-level challenges.

### Tech Stack
- **Languages**: Go
- **Concepts**: cli, visualization, go, systems
- **License**: Apache-2.0
